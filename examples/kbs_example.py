"""
KBS Provider Example
====================
Demonstrates all public methods available through the KBS data provider.
KBS is the default provider in vnstock (no credentials required).
